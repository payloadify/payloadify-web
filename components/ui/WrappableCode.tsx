 ...
 *  `extraControls` is an optional slot for caller-specific buttons rendered next to "Wrap".
 *  `wrap`/`onWrapChange` let a caller control the wrap state externally (e.g. the CVSS calculator
 *  moves its wrap toggle into the Additional Settings panel) — left unset, this component manages
 *  its own state and renders its own "Wrap"/"No wrap" button as before. */
export function WrappableCode({
  text,
  extraControls,
  wrap: wrapProp,
  onWrapChange,
