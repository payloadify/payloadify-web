...
export const VRT_CATEGORIES: VrtCategory[] = [
  { id: "xss-reflected", label: "Cross-Site Scripting (XSS) > Reflected > Non-Self", priority: "P3" },
  { id: "xss-stored", label: "Cross-Site Scripting (XSS) > Stored > Non-Privileged User to Anyone", priority: "P2" },
  {
    id: "xss-dom",
  ...
  { id: "sqli-generic", label: "Server-Side Injection > SQL Injection", priority: "P1" },
  {
    id: "idor",
  ...
  { id: "xxe", label: "Server-Side Injection > XML External Entity Injection (XXE)", priority: "P1" },
  {
    id: "path-traversal",
