...
export type HashSignature = {
  ...
  name: string;
  hashcatModes: number[];
  /** The `--format=` value for John the Ripper (jumbo). `null` when there's no clean/reliable
   *  John equivalent for this signature (mirrors the hashcatModes empty-array pattern above, see
   *  NO_JOHN_FORMAT_NOTE). Verified against John jumbo's source (bleeding-jumbo branch) rather
   *  than guessed, entry-by-entry, per this project's correctness bar. */
...
const NO_JOHN_FORMAT_NOTE = "Not directly supported by John the Ripper (no dedicated format).";
...
export const HASH_SIGNATURES: HashSignature[] = [
  ...
  },
  {
    ...
    specificity: HEX_RARE,
    prevalenceRank: 4,
    note: `Obsolete, very rarely seen in practice. ${NO_HASHCAT_MODE_NOTE} John requires wrapping the hash as $md2$<hex> first.`,
  },
  {
    id: "ripemd128",
    name: "RIPEMD-128",
    hashcatModes: [],
    johnFormat: "ripemd-128",
    test: (s) => hexOfLength(32).test(s),
    specificity: HEX_RARE,
    prevalenceRank: 5,
    note: `Rare. ${NO_HASHCAT_MODE_NOTE} John requires wrapping the hash as $ripemd$<hex> first.`,
  },
  {
    id: "tiger128",
    name: "Tiger-128",
    ...
    specificity: HEX_RARE,
    prevalenceRank: 6,
    note: `Rare. ${NO_HASHCAT_MODE_NOTE} ${NO_JOHN_FORMAT_NOTE} John's only Tiger format is full 192-bit Tiger, not this truncated 128-bit variant.`,
  },
  {
    id: "haval128",
    name: "HAVAL-128",
    ...
    specificity: HEX_RARE,
    prevalenceRank: 7,
    note: `Rare. ${NO_HASHCAT_MODE_NOTE} ${NO_JOHN_FORMAT_NOTE} John's HAVAL format also needs a pass-count (e.g. HAVAL-128-4) that isn't recoverable from the hash alone.`,
  },
  {
    id: "lm",
    name: "LM",
  ...
  },
  {
    ...
    specificity: HEX_RARE,
    prevalenceRank: 2,
    note: "Same length as SHA-1 but much less commonly used. John requires wrapping the hash as $ripemd$<hex> first.",
  },
  {
    id: "haval160",
    name: "HAVAL-160",
    ...
    specificity: HEX_RARE,
    prevalenceRank: 3,
    note: `Same length as SHA-1 but rare. ${NO_HASHCAT_MODE_NOTE} ${NO_JOHN_FORMAT_NOTE} John's HAVAL format also needs a pass-count (e.g. HAVAL-160-4) that isn't recoverable from the hash alone.`,
  },
  ...
  },
  {
    ...
    specificity: HEX_RARE,
    prevalenceRank: 2,
    note: `Same length as SHA-256 but much less commonly used. ${NO_JOHN_FORMAT_NOTE}`,
  },
  {
    id: "keccak-256",
    name: "Keccak-256",
    ...
    specificity: HEX_RARE,
    prevalenceRank: 3,
    note: `Same length as SHA-256/SHA3-256 but distinct pre-standardization Keccak padding — uses a different Hashcat mode than SHA3-256. ${NO_JOHN_FORMAT_NOTE}`,
  },
  {
    id: "ripemd256",
    name: "RIPEMD-256",
    ...
    specificity: HEX_RARE,
    prevalenceRank: 4,
    note: `Same length as SHA-256 but rare. ${NO_HASHCAT_MODE_NOTE} ${NO_JOHN_FORMAT_NOTE}`,
  },
  ...
  },
  {
    ...
    specificity: HEX_RARE,
    prevalenceRank: 3,
    note: `Same length as SHA-512/Whirlpool but distinct algorithm — uses a different Hashcat mode than Whirlpool. ${NO_JOHN_FORMAT_NOTE}`,
  },
];
